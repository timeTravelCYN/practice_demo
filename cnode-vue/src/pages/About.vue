<template>
    <div class="about">
        <div class="auserinfo" v-if="userInfo.loginname">
            <img class="auserinfo-avatar" :src="userInfo.avatar_url">
            <p class="auserinfo-nickname">{{ userInfo.loginname}}</p>
        </div>
        <div class="auserinfo" v-else>
            <img class="auserinfo-avatar" src="~assets/timg.jpg">
            <p class="auserinfo-nickname">timetravel</p>
        </div>
        ...
        <div class="about-box">
            ...
            <div class="about-item">
                ...
                <p class="about-item-content link">https://timetravelcyn.github.io/</p>
            </div>
            <div class="about-item">
