<template lang="html">
  <div class="page login">
    <div class="login-item">
      <img class="login-item-img" src="https://o4j806krb.qnssl.com/public/images/cnodejs_light.svg" alt="">
      <div class="login-item-section">
        <input type="text" class="login-item-input" placeholder="请输入Token" v-model="accesstoken" />
      </div>
