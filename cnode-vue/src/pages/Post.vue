<template lang="html">
  <div class="post">
    <div class="title">
      <label for="" class="iconfont icon-biaoti1"></label>标题
      <input type="text" placeholder="请输入标题" v-model="form.title">
    </div>
    <div class="select">
      <label for="" class="iconfont con-fenlei"></label>分类
    ...
    <div class="con">
      <label for="" class="iconfont icon-biaoti"></label>内容
