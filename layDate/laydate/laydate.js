...
;!function(){
  "use strict";
  var formatFunc = function(time, format){
    var t = new Date(time);
  ...
  */
  ...
  Class.prototype.render = function(){
    ...
    var hour = '<select style="width: 50px;height: 23px" id="chooseHour">'
    ,minSel = '<select style="width: 50px;height: 23px" id="chooseMinutes">'
    ,now = new Date()
  ...
  Class.prototype.systemDate = function(newDate){
    ...
    return {
      ...
      ,hours: newDate ? newDate.getHours() : thisDate.getHours() //时
      ,minutes: newDate ? newDate.getMinutes() : thisDate.getMinutes() //分
  ...
  Class.prototype.calendar = function(value){
    ...
    document.getElementById('chooseHour').value = dateTime.hours
    document.getElementById('chooseMinutes').value = dateTime.minutes
    ...
    document.getElementById('chooseHour').onchange = function() {
      that.chooseTime(this, 'hours')
    }
    document.getElementById('chooseMinutes').onchange = function() {
      that.chooseTime(this, 'minutes')
    }
    //赋值日
  ...
  Class.prototype.setValue = function(value){
    ...
    if(date.getTime() - (nowDate.getTime() + 10*60*1000) > 0) {

    }else {
      value = formatFunc((nowDate.getTime() + 10*60*1000), 'yyyy-MM-dd HH:mm')
    }
  ...
  // 选择时分
  Class.prototype.chooseTime = function(select, type) {
    var that = this,
    options = that.config,
    dateTime = options.dateTime,
    ...
    dateTime[type] = parseInt(value, 10)
